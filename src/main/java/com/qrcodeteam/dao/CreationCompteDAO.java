...
public class CreationCompteDAO {
	...
	public static void insertEntreprise(Connection con, Entreprise e) {
		...
		try {
			...
			pstmt.setString(14, new DateTime().toString(dtf));
			//pstmt.setString(14, c.getDateImmatriculationCommerce().toString(dtf));
	...
	public static void insertEmployeur(Connection con, Employe e) {
		...
		try {
			...
			//pstmt.setString(4, e.getDdnEmploye().toString(dtf));
			pstmt.setString(4, new DateTime().toString(dtf));
