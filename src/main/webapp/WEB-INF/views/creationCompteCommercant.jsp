...
<div class="container">
<form:form id="creerCompteGerantCommerce-form" action="creationCompteCommercant" method ="post" commandName="commerceGerantForm" enctype="multipart/form-data">
	<form:errors path = "*" cssClass = "errorblock" element = "div" />
	<div class="row form-group">
        <div class="col-xs-12">
            <ul class="nav nav-pills nav-justified thumbnail setup-panel">
                <li class="active"><a href="#step-1">
                    <h4 class="list-group-item-heading">Gérant</h4>
                    <p class="list-group-item-text">Information sur le Gérant</p>
                </a></li>
                <li class="disabled"><a href="#step-2">
                    <h4 class="list-group-item-heading">Commerce</h4>
                    <p class="list-group-item-text">Information sur le commerce</p>
                </a></li>
    ...
    <div class="row setup-content" id="step-1">
           ...
           <div class="row">
			...
			<div class="panel panel-primary">
				...
				<div class="row">
        			...
        			<label for="civilite">Civilité :<span class="req">* </span></label>
                     ...
                     <form:select name="civiliteGerant" id="civiliteGerant"  class="form-control"  path="g.civiliteGerant" items="${civiliteList}" required="required"/>
        				</div>
        			</div>
        			...
        			<div class="col-md-6">
        				...
        				<form:input size="16" type="text" path="g.ddnGerant" name="ddnGerant" id="ddnGerant"  class="form-control form_datetime" readonly="readonly" required="required"/>    
                      </div>      
        			</div>
            ...
            <div class="form-group">
                ...
                <form:input type="text" class="form-control" path="g.nomGerant" name="nomGerant" id="nomGerant" placeholder="MOUNSIF" required="required"/>
            </div>
            </div>
            <div class="col-md-6">
            <div class="form-group">
                <label for="validate-text">Prenom :<span class="req">* </span></label> 
                <form:input type="text" class="form-control" path="g.prenomGerant" name="prenomGerant" id="prenomGerant" placeholder="Karim" required="required"/>
            </div>
            </div>
        		</div>
                ...
                <form:input type="text" class="form-control" path="g.adresseGerant" name="adresseGerant" id="adresseGerant" placeholder="20 Avenue Albert Einstein" required="required"/>
            </div>
            </div>
        		<div class="col-md-6">
        		 <div class="form-group">
                <label for="validate-text">Email :<span class="req">* </span></label> 
                <form:input type="text" class="form-control" path="g.mailGerant" name="mailGerant" id="mailGerant" placeholder="karim.mounsif@insa-lyon.fr" required="required"/>
            </div>
        		</div>
        		</div>
                ...
                <form:input type="text" class="form-control" path="g.codePostalGerant" name="codePostalGerant" id="codePostalGerant" placeholder="ex. 69100" required="required"/>
            </div>
            </div>
            <div class="col-md-4 col-xs-4">
            <div class="form-group">
                <label for="validate-text">Ville :<span class="req">* </span></label> 
                <form:input type="text" class="form-control" path="g.villeGerant" name="villeGerant" id="villeGerant" placeholder="Villeurbanne" required="required"/>
            </div>
        		</div>
                ...
                <input type="text" class="form-control" name="mailGerantConf" id="mailGerantConf" placeholder="karim.mounsif@insa-lyon.fr" required="required">
           		</div>
        		</div>
			  ...
			  <form:input type="text" class="form-control" path="g.telGerant" name="telGerant" id="telGerant" placeholder="756473829" aria-describedby="inputGroupSuccess1Status"/>
  			</div>
        		</div>
    ...
    <div class="row setup-content" id="step-2">
          <div class="row">
			...
			<div class="panel panel-primary">
                ...
                <form:input type="text" class="form-control" path="c.siretCommerce" name="siretCommerce" id="siretCommerce" placeholder="48834299900023" required="required"/>
            		</div>
        		...
        		<div class="col-md-6">
            <div class="form-group">
                <label for="Nom">Nom du Commerce :<span class="req">* </span></label> 
                <form:input type="text" class="form-control" path="c.nomCommerce" name="nomCommerce" id="nomCommerce" placeholder="ex. NINKASI EVENEMENTS" required="required"/>
            </div>
            </div>
            <div class="col-md-6">
            <div class="form-group">
                <label for="validate-text">Type de  Commerce :<span class="req">* </span></label> 
                 <form:select name="typeCommerce" id="typeCommercant"  class="form-control"  path="c.typeCommerce" items="${typeCommerceList}" required="required"/>
        		</div>            
            </div>
        		</div>
        		...
        		<div class="col-md-6">
        		 <div class="form-group">
                <label for="validate-text">Adresse :<span class="req">* </span></label> 
                <form:input type="text" class="form-control" path="c.adresseCommerce" name="adresseCommerce" id="adresseCommerce" placeholder="20 Avenue Albert Einstein" required="required"/>
            </div>
            </div>
        		<div class="col-md-6">
        		 <div class="form-group">
                <label for="validate-text">Date immatriculation :<span class="req">* </span></label> 
                <form:input size="16" type="text" path="c.dateImmatriculationCommerce" name="dateImmatricualtionCommerce" id="dateImmatricualtionCommerce"  class="form-control form_datetime" readonly="readonly" required="required"/>    
            </div>
        		</div>
        		</div>
        		...
        		<div class="row">
        		 ...
        		 <div class="form-group">
                <label for="validate-text">Boite Postale :<span class="req">* </span></label> 
                <form:input type="text" class="form-control" path="c.codePostalCommerce" name="codePostalCommerce" id="codePostalCommerce" placeholder="ex. 69100" required="required"/>
            </div>
            </div>
            <div class="col-md-4 col-xs-4">
            <div class="form-group">
                <label for="validate-text">Ville :<span class="req">* </span></label> 
                <form:input type="text" path="c.villeCommerce" class="form-control" name="villeCommerce" id="villeCommerce" placeholder="Villeurbanne" required="required"/>
            </div>
        		</div>
                ...
                <form:input type="text" class="form-control" path="c.capitalSocialCommerce" name="capitalSocialCommerce" id="capitalSocialCommerce" placeholder="1000000" required="required"/>
           		</div>
        		</div>
        		<div class="col-md-3">
        			<div class="form-group">
                <label for="validate-text">Effectif :<span class="req">* </span></label> 
                <form:input type="text" class="form-control" path="c.effectifCommerce" name="effectifCommerce" id="effectifCommerce" placeholder="ex. 3000" required="required"/>
           		</div>
        		</div>
			  ...
			  <div class="input-group">
			   <span class="input-group-addon">(+33)</span>
			  <form:input type="text" class="form-control" path="c.telCommerce" name="telCommmerce" id="telCommerce" placeholder="756473829" aria-describedby="inputGroupSuccess1Status"/>
  			</div>
                ...
                <form:input type="text" class="form-control" path="c.ribCommerce" name="ribCommerce" id="ribCommerce" placeholder="0756473829393939393939" required="required"/>
           		</div>
        		</div>
        		</div>
		...
		<div class="col-md-6">
        		 <div class="form-group">
                <label for="validate-text">Email :<span class="req">* </span></label> 
                <form:input type="text" class="form-control" path="c.mailCommerce" name="mailCommerce" id="mailCommerce" placeholder="carrefourVenisseiux@insa-lyon.fr" required="required"/>
            </div>
        			<div class="form-group">
                <label for="validate-text">Confirmation Email :<span class="req">* </span></label> 
                <input type="text" class="form-control" name="c.mailCommerceConf" id="mailCommerceConf" placeholder="karim.mounsif@insa-lyon.fr" required="required">
           		</div>
        		
        		</div>
        		<div class="col-md-6">
				<div class="form-group">
    				<label for="exampleFormControlTextarea1">Description du commerce :</label>
   				 <form:textarea class="form-control" cols="15" path="c.descriptionCommerce" name="descriptionCommerce" id="descriptionCommerce" rows="5"/>
  				</div>
        		</div>
        		</div>
	...
	<div class="col-md-12">
			<div class="panel panel-default">
				<div class="panel-heading"><strong>Papier au format PDF ou JPEG</strong> <small> </small></div>
				<div class="panel-body">
...
Aenean quis tristique est. Morbi luctus mattis justo, a iaculis sapien. Praesent hendrerit sapien eu tempor laoreet. Nunc pretium maximus lorem, eu cursus arcu molestie non. Fusce libero felis, commodo ac pharetra nec, sagittis in tortor. Donec egestas sit amet turpis in facilisis. In volutpat elit a ante sagittis facilisis. Ut nec mi massa. Suspendisse sed nibh arcu. Nulla varius ultricies nibh, vitae egestas mauris dapibus eget. Ut luctus arcu quam, id venenatis lorem laoreet ac. Curabitur eget mi in libero ornare luctus eu nec felis. Etiam porttitor ullamcorper quam.
...
Sed commodo viverra velit. Cras ultrices semper nisi sit amet vehicula. Mauris nec maximus mi, et molestie lectus. Pellentesque eleifend mi aliquam tellus elementum dignissim. Mauris tristique lectus et mauris pretium dapibus. Nullam ac nunc ex. Donec auctor eros sed nibh ornare, eget commodo orci tempor. Integer mollis mauris nisl, sed elementum lorem feugiat ac. Cras metus est, sodales at consectetur in, commodo eu mauris. Mauris cursus tellus ut justo bibendum sodales. Cras sed ullamcorper lectus, id sollicitudin risus. Nulla odio quam, posuere non mollis et, molestie a lorem. Nam vitae est vel ligula dapibus ullamcorper sed id odio. Nullam consectetur, mi ut hendrerit dictum, metus tortor pellentesque ligula, congue placerat tellus orci ut odio. Praesent facilisis neque et eros molestie, quis consequat ante ultricies.
...
Mauris ut elit nulla. In eu mi sagittis, fermentum mauris ac, placerat ipsum. Duis hendrerit sapien id auctor hendrerit. Aliquam fringilla lacus nibh, sed tempor libero cursus ac. Donec euismod elit lectus, condimentum interdum mauris cursus sit amet. Fusce erat lorem, bibendum sit amet felis sed, porta elementum nunc. Etiam dictum quis tortor nec tincidunt.
