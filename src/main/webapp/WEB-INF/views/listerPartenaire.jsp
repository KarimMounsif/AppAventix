    ...
    <div class="row">
        <div class="col-md-12">
            <ul id="nav-tabs-wrapper" class="nav nav-tabs nav-tabs-horizontal">
              <li class="active"><a href="#htab1" data-toggle="tab">Commerce<span class="badge">${nbComPartenaire}</span></a></li>
              <li><a href="#htab2" data-toggle="tab">Entreprise<span class="badge">${nbEntPartenaire}</span></a></li>
            </ul>
            	...
            	<div class="tab-content">
                	    ...
                	    <div class="row">
                            <div class="card">
                                <div class="card-header" data-background-color="">
                                    ...
                                    <p class="category">Liste des Partenaires</p>
                                </div>
                	...
                	<c:forEach var="ComGer" items="${listCommerce}">
		      		 ...
		      		 <tr class="items">
                             ...
                             <td><c:out value="${ComGer.c.mailCommerce}"/><br><c:out value="${ComGer.c.telCommerce}"/></td>
                             <td><c:out value="${ComGer.g.nomGerant}"/>&nbsp&nbsp<c:out value="${ComGer.g.prenomGerant}"/><br/>
                             	<c:out value="${ComGer.g.mailGerant}"/> &nbsp&nbsp <c:out value="${ComGer.g.telGerant}"/></td>
                             	<td>
          ...
          <ul class="dropdown-menu" role="menu">
            <li><a href="#">Obtenir Détails</a></li>
            <li><a href="#">Résilier Partenariat</a></li>
          </ul>
        </div>
